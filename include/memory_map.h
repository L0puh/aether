...
#define FLASH_HV_LENGTH   0x8000UL      /* 32K */ 
...
#define RAM_HV_LENGTH     0x2000UL      /* 8K */

#define RAM_GUARD_ORIGIN  0x20002000UL
#define RAM_GUARD_LENGTH  0x400UL       /* 1K */ 

#define RAM_APP_ORIGIN    0x20004000UL
#define RAM_APP_LENGTH    0x1000UL      /* 4K */ 
